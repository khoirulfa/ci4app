...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="container mt-1">
            <a href="/guru/create" class="btn btn-primary btn-sm mt-1 ">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($teachers as $teacher) : ?>
                                <tr>
                                    ...
                                    <td scope="col" style="text-align: center;"><?= $teacher['jabatan']; ?></td>
                                    <td scope="col" style="text-align: center;">
                                        <?php
                                        if ($teacher['jabatan'] == 'kepsek' || $teacher['jabatan'] == 'waka') {
                                            echo '-';
                                        } else {
                                            echo $teacher['mapel'];
                                        }
                                    ...
                                    <td scope="col" style="text-align: center;">
                                        ...
                                        } elseif ($teacher['pendidikan'] == 'waka') {
                                            echo 'Waka';
                                        } else {
