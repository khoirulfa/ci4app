                        ...
                        <div class="form-row form-group">
                           ...
                           <div class="col">
                              ...
                              <div class="input-group flex-nowrap">
                                 ...
                                 <input type="text" class="form-control datepicker" placeholder="Tanggal lahir" id="tanggallahir" name="tan_lahir" autocomplete="off" value="<?= (old('tan_lahir')) ? old('tan_lahir') : $dataSiswa['tan_lahir'] ?>">
                              </div>
                           </div>
                        </div>
                        <div class="form-row form-group">
